...
const loader = new CheerioWebBaseLoader("https://nvie.com/posts/a-successful-git-branching-model");
...
const vectorstore = await MemoryVectorStore.fromDocuments(docs, new OllamaEmbeddings({ model: "llama2", baseUrl: hostRemote }));
